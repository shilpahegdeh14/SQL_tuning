--Question 4.3: Write a SQL query to find the total number of conference publications for each decade,
...
CREATE INDEX idx_distinctyear_year ON DistinctYears(year);
CREATE INDEX idx_ip_year ON inproceedings(year);
